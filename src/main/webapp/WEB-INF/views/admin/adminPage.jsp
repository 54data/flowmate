				        ...
				        <tr>
				            ...
				            <td>
				            	<select class="form-select" id="inputDept" name="memberDeptId">
									<option value="102001" ${enableMember.memberDept == '101001' ? 'selected' : ''}>공공사업1팀</option>
									<option value="102002" ${enableMember.memberDept == '101002' ? 'selected' : ''}>공공사업2팀</option>
									<option value="102003" ${enableMember.memberDept == '101003' ? 'selected' : ''}>공공사업3팀</option>			
								</select>
				            </td>
				            <td>
				            	<select class="form-select" id="inputRank" name="memberRankId">
									<option value="102001" ${enableMember.memberRankId == '102001' ? 'selected' : ''}>부장</option>
									<option value="102002" ${enableMember.memberRankId == '102002' ? 'selected' : ''}>차장</option>
									<option value="102003" ${enableMember.memberRankId == '102003' ? 'selected' : ''}>과장</option>			
									<option value="102004" ${enableMember.memberRankId == '102004' ? 'selected' : ''}>팀장</option>
									<option value="102005" ${enableMember.memberRankId == '102005' ? 'selected' : ''}>대리</option>
									<option value="102006" ${enableMember.memberRankId == '102006' ? 'selected' : ''}>사원</option>										
								</select>
				            </td>
				            <td>
				            	<span>
