	...
	<form id="sendMessage"  enctype="multipart/form-data" >
		...
		<div class="d-flex align-items-center mt-1 mb-1 w-100">
			...
			<div class="ms-reciverSelect w-100">
				<select class="reciver-select w-100" name="memberIds" multiple="multiple">
				</select>
			</div>
		</div>
		<div class="mt-3">
			...
			<div class="w-100">
				<textarea class="message-content form-control border p-3 bg-white" placeholder="내용을 입력하세요." id="project-textarea" name="messageContent"></textarea>
			</div>
		</div>
		<div class="mt-2">
			<div class="d-flex align-items-center" style="height: 40px;">
		 		<div><h5>첨부파일</h5></div>
				<span class="file-count badge rounded-pill bg-light ms-2">0</span>
				...
				<input class="message-file-input form-control" name="files" type="file" style="display:none" multiple>
			</div>
			<div class="message-file-preview d-flex">
			</div>
		</div>		
		<div>
			<button type="button" class="sendMsg mt-3 btn btn-outline-primary">보내기</button>
		</div>
	</form>	
	</div>
