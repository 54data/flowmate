...
<body>
	...
	<div class="d-flex min-vh-100">
		...
		<article class="mt-4 ms-4 pe-4">
			<h2 class="ptitle h2 m-0">결재 관리</h2>
			<div class="d-flex justify-content-between align-items-center">
				<div class="d-flex mt-4 justify-content-start">
					<select class="form-select" id="prjApprSelect" name="prjApprSelect">
						<option>작업 ID</option>
						<option>작업명</option>
						<option>담당자</option>
					</select>
					<form class="searchForm d-flex justify-content-end">
						<input class="form-control me-sm-2 ms-4" type="search" id="prjApprInput" placeholder="검색어를 입력해주세요">
			...
			<section>
				<table id="prjApprList" class="table text-center">
					<thead>
						<tr>
							<th>작업ID</th>
							<th>작업명</th>
					...
					<tbody>
						<c:forEach items="${apprList}" var="approval">
							<tr>
								...
								<td>
									<span class="approve-btn" data-approval-id="${approval.approvalId}" data-project-id="${approval.projectId}" data-task-id="${approval.taskId}">승인</span>
									/
									<span class="reject-btn" data-approval-id="${approval.approvalId}" data-project-id="${approval.projectId}" data-task-id="${approval.taskId}">반려</span>
								</td>
							</tr>
						</c:forEach>
					</tbody>
	...
	<script src="${pageContext.request.contextPath}/resources/js/approvalStay.js"></script>
</body>
</html>