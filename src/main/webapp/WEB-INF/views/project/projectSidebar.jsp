		...
		<div class="flowmate-sidebar d-flex flex-column pt-4 border-end">
			<a href="${pageContext.request.contextPath}/project/projectBoard">		
				<div class="d-flex align-items-center mb-4">
					...
					<span class="sidebar-menu ms-1">프로젝트 보드</span>
				</div>
			</a>
			<a href="${pageContext.request.contextPath}/project/projectIssue">			
				<div class="d-flex align-items-center mb-4 mt-1">
					...
					<span class="sidebar-menu ms-1">이슈 목록</span>
				</div>
			</a>
			<a href="${pageContext.request.contextPath}/notice/noticeList?pageNo=1">				
				<div class="d-flex align-items-center mb-4 mt-1">
					...
					<span class="sidebar-menu ms-1">공지사항</span>
				</div>
			</a>		
			<a href="${pageContext.request.contextPath}/project/projectMember">				
				<div class="d-flex align-items-center mb-4 mt-1">
					...
					<span class="sidebar-menu ms-1">팀원 목록</span>
				</div>
			</a>
			<a href="${pageContext.request.contextPath}/project/projectTask">			
				<div class="d-flex align-items-center mb-4 mt-1">
					...
					<span class="sidebar-menu ms-1">작업 목록</span>
				</div>
			</a>
			<a href="${pageContext.request.contextPath}/project/projectApprovalList">			
				<div class="d-flex align-items-center mb-4 mt-1">
					...
					<span class="sidebar-menu ms-1">결재 목록</span>
				</div>
			</a>
			<a href="#">			
				<div class="d-flex align-items-center mb-4 mt-1">
					...
					<span class="sidebar-menu ms-1">프로젝트 통계</span>
				</div>
			</a>
		</div>
	</body>
