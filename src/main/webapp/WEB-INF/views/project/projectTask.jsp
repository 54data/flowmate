				...
				<thead>
				        ...
				        <tr class="task-updateModal" >
				            <td style="cursor: pointer;">
				            		${proTask.fmtTaskId}
				            		<input type="hidden" value="${proTask.taskId}" class="taskId" >
				            		<input type="hidden" value="${proTask.projectId}" class="taskProjectId" >
				            </td>
				            <td style="cursor: pointer;">	${proTask.taskName}</td>
