$(document).ready(function() {
    ...
    let table = $('#adminPageStayTable').DataTable({
		order: [0, 'desc'],
		orderClasses: true,
		columns: columns,
    ...
    $('#adminPageStaySelecet').on('change', function() {
        ...
        var searchTerm = $('#adminPageStayInput').val();
    ...
    $('#adminPageStayInput').on('input keyup', function() {
